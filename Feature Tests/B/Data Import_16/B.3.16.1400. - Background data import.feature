Feature: User Interface: The system shall allow data to be uploaded as background process with the csv template to create and/or modify records.
    ...
    Scenario: B.3.16.1400.100 Background Data Import
        ...
        And I create a new project named "B.3.16.1400.100" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file
        "BigDataTestProject.xml", and clicking the "Create Project" button
        ...
        Then I should see a table header and rows including the following values in the logging
            table:
