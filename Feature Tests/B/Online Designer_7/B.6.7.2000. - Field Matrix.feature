Feature: Field Creation: The system shall support the creation and spliting matrix of fields
    ...
    Scenario: B.6.7.2000.100 Matrix of Fields through the Online Designer
        ...
        And I create a new project named "B.6.7.2000.100" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing "Empty project", and clicking the "Create Project" button
        ...
        And I should see a field name  with the variable name " flavor3"
