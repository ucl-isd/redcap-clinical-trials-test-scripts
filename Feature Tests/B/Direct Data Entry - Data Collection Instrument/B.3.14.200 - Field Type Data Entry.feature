Feature: Creating a Record and Entering Data: The system shall support data entry for the defined core field types.
    ...
    Scenario: B.3.14.200.100 Appropriate data entry by field type
        ...
        And I click the link "Add signature" for the singature field labeled "Signature"
        ...
        And I upload the file labeled "File_Upload.png"
        ...
        Then I should see table rows containing the following values in the logging table:
            ...
            | test_user1 | Create record 7 | multiple_dropdown_manual_2 = '6'        |
            | test_user1 | Create record 7 | notesbox2 = 'Notes box'                 |
            | test_user1 | Create record 7 | checkbox(1) = checked                   |
            | test_user1 | Create record 7 | checkbox(2) = checked                   |
            | test_user1 | Create record 7 | signature = '(unique signature hash)'   |
            | test_user1 | Create record 7 | file upload = '(unique file hash)'      |
            | test_user1 | Create record 7 | tf= '1'                                 |
