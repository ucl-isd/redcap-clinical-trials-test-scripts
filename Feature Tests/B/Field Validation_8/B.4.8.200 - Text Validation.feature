Feature: User Interface: The system shall support text validation for text field types: Date (Y-M-D) | Datetime (Y-M-D H:M) | Datetime w/seconds (Y-M-D H:M:S) |  Email  | Integer | Numbers | Number (1 decimal place - comma as decimal) | Time (HH:MM)  | Time (MM:SS) | Time (HH:MM:SS)
    ...
    Scenario: B.4.8.200.100 Field validation type
        ...
        Then I should see a table header and rows including the following values in the logging table:
            ...
            | test_user1 | Update record 5 | email = 'email@test.edu'                  |
            | test_user1 | Create record 5 | date_ymd = '2023-08-02'                   |
            | test_user1 | Create record 5 | datetime_ymd_hm = '2023-09-02 01:03'      |
            | test_user1 | Create record 5 | datetime_ymd_hmss = '2023-09-02 01:03:01' |
            | test_user1 | Create record 5 | integer = '99'                            |
            | test_user1 | Create record 5 | number = '4'                              |
            | test_user1 | Create record 5 | number_dec = '1.5'                        |
            | test_user1 | Create record 5 | num_comma = '1,5'                         |
            | test_user1 | Create record 5 | time_hhmm = '08:10'                       |
        ...
        Then I should see a table header and rows containing the following values in the logging table:
            | Username   | Action          | List of Data Changes OR Fields Exported   |
            | test_user1 | Create record 6 | date_ymd = '2023-09-01'                   |
            | test_user1 | Create record 6 | datetime_ymd_hm = '2023-08-02 01:03'      |
            | test_user1 | Create record 6 | datetime_ymd_hmss = '2023-10-02 01:03:01' |
            | test_user1 | Create record 6 | integer = '101'                           |
            | test_user1 | Create record 6 | number = '6'                              |
            | test_user1 | Create record 6 | number_dec = '5.1'                        |
            | test_user1 | Create record 6 | num_comma = '5,1'                         |
            | test_user1 | Create record 6 | time_hhmm = '07:05'                       |
